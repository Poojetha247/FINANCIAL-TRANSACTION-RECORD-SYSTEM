...
import com.wipro.ftrs.service.FinancialTransactionService; import com.wipro.ftrs.util.*;
...
accounts.add(new Account("A001", "Vishal Kumar", 5000)); accounts.add(new Account("A002", "Neha Sharma", 7000));
...
for (TransactionRecord tr : service.getTransactionHistory("A001")) { System.out.println(tr.getType() + " - " + tr.getAmount());
}
